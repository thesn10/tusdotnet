...
namespace tusdotnet.Storage
{
    ...
    /// Not recommended because it requires <see cref="IHttpContextAccessor"/>
    /// Alternatively, use <see cref="TusStorageClient.Create(ITusStore)"/> inside your controller instead of this configurator.
    /// </summary>
