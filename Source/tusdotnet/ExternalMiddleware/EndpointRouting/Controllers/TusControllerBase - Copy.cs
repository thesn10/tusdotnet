...
{
    public abstract class TusControllerBase<TOptions>
    {
        ...
        /// <summary>
        /// Gets the <see cref="TusStorageService"/> for the executing action.
        /// </summary>
        /// /// <remarks>
        /// <see cref="TusProtocolHandlerEndpointBased{TController}"/> activates this property while activating controllers.
        /// If user code directly instantiates a controller, the getter returns an empty HttpContext
        /// </remarks>
        public TusStorageService Storage { get; internal set; }


        /// <summary>
        /// Gets the <see cref="TOptions"/> of the controller.
        /// </summary>
        /// /// <remarks>
        /// <see cref="TusProtocolHandlerEndpointBased{TController}"/> activates this property while activating controllers.
        /// If user code directly instantiates a controller, the getter returns an empty HttpContext
        ...
        public abstract Task<ITusDeleteActionResult> Delete(DeleteContext context, CancellationToken cancellationToken);
        ...
        protected ITusDeleteActionResult DeleteOk() => new TusDeleteOk();
